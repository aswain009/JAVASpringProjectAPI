...
INSERT INTO productlines (productLine, textDescription, htmlDescription, image) VALUES
  ('Engine Components', 'Core engine parts focused on reliability, performance, and serviceability.', '<p>Core engine components for maintenance and light performance upgrades, including belts, pumps, gaskets, and ignition parts.</p>', NULL),
  ('Braking Systems', 'Friction components and hydraulics for safe, consistent stopping.', '<p>Pads, rotors, calipers, and hydraulic parts designed for daily driving and fleet duty.</p>', NULL),
  ('Suspension & Steering', 'Ride control and steering precision for comfort and safety.', '<p>Struts, control arms, ball joints, and steering pumps for alignment and handling.</p>', NULL),
  ('Filters & Fluids', 'Service interval consumables that extend component life.', '<p>Oil, air, cabin filters and critical fluids meeting OE specifications.</p>', NULL),
  ('Electrical & Ignition', 'Starting, charging, and ignition reliability under all conditions.', '<p>Alternators, starters, coils, sensors, and battery accessories.</p>', NULL),
  ('Exhaust & Emissions', 'Flow and emissions control with durable materials.', '<p>Catalytic converters, mufflers, pipes, clamps, and EGR components.</p>', NULL),
  ('Cooling System', 'Thermal control to protect engines and transmissions.', '<p>Radiators, water pumps, thermostats, hoses, and fan assemblies.</p>', NULL),
  ('Drivetrain & Transmission', 'Power delivery components for smooth, reliable operation.', '<p>Clutch kits, CV axles, hubs, filters, and differential fluids.</p>', NULL),
  ('Body & Lighting', 'Visibility and exterior replacement parts.', '<p>Headlights, tail lights, mirrors, bumper covers, and wiper blades.</p>', NULL),
  ('Tools & Shop Supplies', 'Essential tools and consumables for DIY and fleet shops.', '<p>Torque tools, diagnostic scanners, bleeding kits, gloves, and funnels.</p>', NULL);
...
INSERT INTO products (productCode, productName, productLine, productVendor, productDescription, quantityInStock, buyPrice, MSRP) VALUES
  ('EN-0001', 'Timing Belt Kit with Tensioner', 'Engine Components', 'ApexAuto', 'OE-spec timing belt kit including belt, idler, and hydraulic tensioner.', 120, 54.00, 99.99),
  ('EN-0002', 'Spark Plug Set Iridium (4-Pack)', 'Engine Components', 'NovaSpark', 'Long-life iridium plugs gapped to OE spec for consistent ignition.', 250, 18.50, 34.95),
  ('EN-0003', 'High Flow Oil Pump', 'Engine Components', 'TorqueTech', 'Increased volume pump for improved lubrication under load.', 60, 79.00, 139.95),
  ('EN-0004', 'Complete Engine Gasket Set', 'Engine Components', 'IronPeak', 'Comprehensive gasket kit for top and bottom end reseal projects.', 40, 115.00, 199.99),
  ('EN-0005', 'Fuel Injector (Single) 12-Hole', 'Engine Components', 'VectorDrive', 'Precision multi-hole injector for improved atomization and idle quality.', 90, 62.00, 109.99),
  ('BR-0001', 'Ceramic Front Brake Pad Set', 'Braking Systems', 'BlueLine Components', 'Low-dust ceramic friction formula with chamfers and shims.', 200, 24.00, 49.99),
  ('BR-0002', 'Vented Brake Rotor 12 in', 'Braking Systems', 'RoadForge', 'Balanced rotor with anti-corrosion coating for extended life.', 180, 33.00, 69.99),
  ('BR-0003', 'Loaded Brake Caliper (Left Front)', 'Braking Systems', 'NorthStar Parts', 'Pre-assembled caliper with bracket and pads for quick service.', 55, 72.00, 129.99),
  ('BR-0004', 'Stainless Braided Brake Hose', 'Braking Systems', 'VectorDrive', 'DOT-compliant hose improves pedal feel and abrasion resistance.', 110, 21.00, 39.99),
  ('BR-0005', 'Master Cylinder Assembly', 'Braking Systems', 'ApexAuto', 'New (not reman) cylinder with bench-bleed fittings included.', 45, 58.00, 109.99),
  ('SS-0001', 'Complete Strut Assembly (Front Left)', 'Suspension & Steering', 'RoadForge', 'Preloaded strut with spring and mount for fast replacement.', 70, 95.00, 169.99),
  ('SS-0002', 'Lower Ball Joint Heavy Duty', 'Suspension & Steering', 'IronPeak', 'Forged housing with grease fitting for extended service life.', 140, 19.50, 39.99),
  ('SS-0003', 'Outer Tie Rod End', 'Suspension & Steering', 'BlueLine Components', 'Heat-treated stud and low-friction bearing for precise steering.', 160, 14.00, 29.99),
  ('SS-0004', 'Aluminum Control Arm with Bushing', 'Suspension & Steering', 'NorthStar Parts', 'OE geometry control arm with pre-installed rubber bushing.', 65, 68.00, 124.99),
  ('SS-0005', 'Power Steering Pump New', 'Suspension & Steering', 'TorqueTech', 'Brand new pump with pulley and O-rings for leak-free install.', 40, 89.00, 159.99),
  ('FF-0001', 'Engine Oil Filter Premium', 'Filters & Fluids', 'ApexAuto', 'Synthetic media filter with silicone anti-drainback valve.', 300, 4.20, 9.99),
  ('FF-0002', 'Engine Air Filter Panel', 'Filters & Fluids', 'BlueLine Components', 'High-flow paper media with reinforced frame.', 220, 6.00, 14.99),
  ('FF-0003', 'Cabin Air Filter Carbon', 'Filters & Fluids', 'NovaSpark', 'Activated carbon media reduces odors and fine particulates.', 210, 7.50, 17.99),
  ('FF-0004', 'ATF Dex VI (1 Quart)', 'Filters & Fluids', 'VectorDrive', 'Fully compatible multi-vehicle ATF meeting Dexron VI spec.', 180, 5.80, 11.99),
  ('FF-0005', 'Coolant Premix 50/50 (1 Gallon)', 'Filters & Fluids', 'IronPeak', 'Silicate-free OAT coolant premixed with deionized water.', 150, 7.90, 16.99),
  ('EI-0001', 'Alternator 120 Amp', 'Electrical & Ignition', 'NorthStar Parts', '100% new alternator with overrunning pulley for quiet operation.', 55, 98.00, 179.99),
  ('EI-0002', 'Starter Motor High Torque', 'Electrical & Ignition', 'TorqueTech', 'Gear reduction design for reliable cold starts.', 60, 85.00, 159.99),
  ('EI-0003', 'Battery 12V 650 CCA', 'Electrical & Ignition', 'SilverRiver', 'Maintenance-free flooded battery with carry handle.', 80, 62.00, 119.99),
  ('EI-0004', 'Ignition Coil Pack', 'Electrical & Ignition', 'NovaSpark', 'Low-resistance windings and epoxy core for strong spark.', 130, 21.50, 44.99),
  ('EI-0005', 'O2 Sensor Upstream', 'Electrical & Ignition', 'VectorDrive', 'Heated sensor for closed-loop fuel control and emissions.', 95, 28.00, 59.99),
  ('EX-0001', 'Catalytic Converter Universal 2.5 in', 'Exhaust & Emissions', 'RoadForge', 'High-load substrate for efficient emissions conversion.', 35, 158.00, 279.99),
  ('EX-0002', 'Stainless Muffler Performance', 'Exhaust & Emissions', 'IronPeak', 'Straight-through design with packed core for durable tone.', 50, 72.00, 139.99),
  ('EX-0003', 'Mandrel Bent Pipe 2.25 in (4 ft)', 'Exhaust & Emissions', 'ApexAuto', 'Aluminized steel for easy fabrication and longevity.', 100, 17.00, 34.99),
  ('EX-0004', 'Exhaust Clamp Kit (10-Pack)', 'Exhaust & Emissions', 'BlueLine Components', 'Assorted U-bolt clamps for 2.0 to 2.75 in pipes.', 140, 12.00, 24.99),
  ('EX-0005', 'EGR Valve OE-Style', 'Exhaust & Emissions', 'NorthStar Parts', 'Precise metering to reduce NOx and prevent stalling.', 45, 58.00, 109.99),
  ('CO-0001', 'Aluminum Radiator', 'Cooling System', 'RoadForge', 'High efficiency core with tig-welded tanks.', 35, 129.00, 229.99),
  ('CO-0002', 'Water Pump with Gasket', 'Cooling System', 'ApexAuto', 'Balanced impeller and sealed bearing for long life.', 75, 32.00, 64.99),
  ('CO-0003', 'Thermostat 195 F', 'Cooling System', 'BlueLine Components', 'OE temperature with bypass jiggle pin for air relief.', 160, 6.50, 13.99),
  ('CO-0004', 'Upper Radiator Hose', 'Cooling System', 'IronPeak', 'EPDM construction with molded bends for exact fit.', 140, 8.20, 18.99),
  ('CO-0005', 'Cooling Fan Assembly', 'Cooling System', 'VectorDrive', 'Dual speed motor and shroud for efficient airflow.', 40, 68.00, 129.99),
  ('DT-0001', 'Clutch Kit Stage 1', 'Drivetrain & Transmission', 'TorqueTech', 'Pressure plate, disc, bearing, and alignment tool included.', 30, 145.00, 269.99),
  ('DT-0002', 'CV Axle Front Right', 'Drivetrain & Transmission', 'NorthStar Parts', 'Heat-treated shafts and moly grease for durability.', 60, 62.00, 119.99),
  ('DT-0003', 'Wheel Hub Assembly with ABS', 'Drivetrain & Transmission', 'IronPeak', 'Pre-pressed bearing and encoder ring for quick install.', 55, 72.00, 139.99),
  ('DT-0004', 'Transmission Filter Kit', 'Drivetrain & Transmission', 'ApexAuto', 'Filter, pan gasket, and hardware for service interval.', 120, 14.50, 29.99),
  ('DT-0005', '75W-90 Gear Oil (1 Quart)', 'Drivetrain & Transmission', 'SilverRiver', 'GL-5 rated synthetic for differentials and axles.', 180, 7.40, 15.99),
  ('BL-0001', 'Headlight Assembly Left', 'Body & Lighting', 'BlueLine Components', 'DOT compliant housing with clear lens and halogen bulb.', 70, 52.00, 99.99),
  ('BL-0002', 'Tail Light Assembly Right', 'Body & Lighting', 'NorthStar Parts', 'Direct fit lens and housing with gasket.', 65, 46.00, 89.99),
  ('BL-0003', 'Front Bumper Cover Primed', 'Body & Lighting', 'RoadForge', 'Ready to paint ABS cover with mounting tabs.', 25, 95.00, 179.99),
  ('BL-0004', 'Power Heated Side Mirror', 'Body & Lighting', 'ApexAuto', 'Direct fit OE style with power adjust and heat.', 50, 58.00, 109.99),
  ('BL-0005', 'Wiper Blade 24 in', 'Body & Lighting', 'SilverRiver', 'Beam style blade for quiet, streak-free wipe.', 220, 5.50, 12.99),
  ('TS-0001', 'Torque Wrench 3/8 in Drive', 'Tools & Shop Supplies', 'GearHouse Tools', 'Micrometer click type with 10–80 ft lb range.', 90, 24.00, 49.99),
  ('TS-0002', 'OBD-II Scanner Handheld', 'Tools & Shop Supplies', 'NovaSpark', 'Reads and clears codes with live data stream.', 40, 48.00, 89.99),
  ('TS-0003', 'Brake Bleeder Kit', 'Tools & Shop Supplies', 'GearHouse Tools', 'Vacuum bleeder with reservoir and adapters.', 55, 22.00, 44.99),
  ('TS-0004', 'Mechanic Gloves Large (Pair)', 'Tools & Shop Supplies', 'SilverRiver', 'Reinforced palm and breathable back panel.', 150, 6.20, 12.99),
  ('TS-0005', 'Funnel Set (3-Piece)', 'Tools & Shop Supplies', 'ApexAuto', 'Chemical resistant funnels for fluids and coolants.', 160, 3.20, 7.99);
